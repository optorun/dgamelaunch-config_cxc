...
VERSIONS="git $(seq 25 34 | sed 's/^/0./')"
...
cp --no-clobber "%%CHROOT_DGLDIR%%/data/crawl-chili-settings/init.txt" "%%CHROOT_RCFILESDIR%%/crawl-chili/$NAME.rc"
cp --no-clobber "%%CHROOT_DGLDIR%%/data/crawl-git.macro" "%%CHROOT_RCFILESDIR%%/crawl-chili/$NAME.macro"
